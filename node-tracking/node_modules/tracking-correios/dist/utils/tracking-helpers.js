...
var Helpers = require('./helpers'); // https://www.correios.com.br/precisa-de-ajuda/como-rastrear-um-objeto/siglas-utilizadas-no-rastreamento-de-objeto
...
function category(object) {
  ...
  var initials = object.substr(0, 2);
  var objectCategory;

  switch (initials) {
    case 'EM':
      var _final = object.substr(object.length - 2, 2);
